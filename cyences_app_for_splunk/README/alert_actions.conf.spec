...
param.alert_state_change_from_setup_page = <1|0> Allow alert state change from setup page?
...
param.email_to_exclude =  <str> Comma separated email addresses to exclude from configured team emails
param.subject_prefix = <str> Text to add as a prefix of email subject
