...
BLOCKSHIELD_STANZA = "blockshield"


class BlockShieldConfRestcall(admin.MConfigHandler):
    """
    ...
    def handleEdit(self, conf_info):
        # Update the BlockShield configuration
        try:
        ...
        try:
            ...
            rest.simpleRequest(
                "/servicesNS/nobody/{}/configs/conf-{}/{}?output_mode=json".format(
                    cs_utils.APP_NAME, CONF_FILE, BLOCKSHIELD_STANZA
                ),
...
if __name__ == "__main__":
    admin.init(BlockShieldConfRestcall, admin.CONTEXT_APP_AND_USER)
